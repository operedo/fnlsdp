...
*/
/*
 * Modified with additional declarations needed for distributed parallel 
 * computations.
 * 
...
/*
 fnlsdp output_info struct
*/
struct outputinfo {
	int nu;
	int ny;
	int nx;
	int alg_data_numerical_num_iter;
	int alg_data_numerical_fr;
	double alg_data_numerical_rho;
	double filter_cand_f;
	double filter_cand_t;
	double filter_cand_constraints_restr1;
	double filter_cand_constraints_restr2;
	double filter_cand_constraints_restr3;
	char alg_data_char;
	double * iterate;
	double * iterate_deriv;
	double norm_iterate_deriv;
};


/*
* A necessary declaration for distributed memory version.
*/
